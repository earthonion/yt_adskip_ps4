...
extern "C" u8 *hexstrtochar2(const char *hexstr, s64 *size)
{
...
// djb2_hash is now defined in patch.h for C++ as constexpr

extern "C" u64 patch_hash_calc(const char *title, const char *name, const char *app_ver,
...
extern "C" void patch_data1(const char *patch_type_str, u64 addr, const char *value, uint32_t source_size, uint64_t jump_target)
{
